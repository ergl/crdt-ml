...
(* OASIS_START *)
(* DO NOT EDIT (digest: 1527439a4c03cf3d63ed72b2cb3621ce) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          copyrights = [];
          maintainers = [];
          authors = ["https://github.com/ergl"];
          homepage = Some "https://github.com/ergl/crdt-ml/";
          synopsis = "CRDTs - OCaml style";
          description = None;
          categories = [];
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "src/mutable";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "crdt_util"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "crdt_mutable";
                           InternalLibrary "crdt_immutable"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title =
                        "API reference for Crdt.Mutable and Crdt.Immutable";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               Test
                 ({
                  ...
                  },
                   {
                      ...
                      test_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "qtest"]
                   })
            ];
          plugins =
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "\224_\027\157\170~\029w\198\242%b$+\167\190";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
